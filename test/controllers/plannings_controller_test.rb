...
class PlanningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planning" do
    assert_difference('Planning.count') do
      post plannings_url, params: { planning: { beginhour: @planning.beginhour, courses: @planning.courses, date: @planning.date, endinghour: @planning.endinghour } }
    end
  ...
  test "should update planning" do
    patch planning_url(@planning), params: { planning: { beginhour: @planning.beginhour, courses: @planning.courses, date: @planning.date, endinghour: @planning.endinghour } }
